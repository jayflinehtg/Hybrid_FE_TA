...
fun TransactionHistoryScreen(
    ...
    val transactionHistory by viewModel.transactionHistory.observeAsState(emptyList())
    val isLoading by viewModel.isLoadingHistory.observeAsState(false)
    val pagination by viewModel.historyPagination.observeAsState()

    // Load data saat screen pertama kali dibuka
    LaunchedEffect(plantId) {
        viewModel.fetchPlantTransactionHistory(plantId, 1, 10)
    }
        ...
        snapshotFlow { listState.layoutInfo.visibleItemsInfo.lastOrNull()?.index }
            .collect { lastVisibleIndex ->
                ...
                if (lastVisibleIndex != null &&
                    ...
                    !isLoading) {
                    viewModel.loadMoreTransactionHistory(plantId)
                }
            }
    }
        ...
        Column(
            ...
            if (isLoading && transactionHistory.isEmpty()) {
                ...
                LazyColumn(
                    ...
                    if (isLoading && transactionHistory.isNotEmpty()) {
                        item {
                            Box(
                                modifier = Modifier
                                    .fillMaxWidth()
...
fun TransactionHistoryItem(
    record: DataClassResponses.TransactionRecord,
    ...
    Card(
        ...
        Column(
            ...
            // Ganache TX Hash dengan copy button
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(bottom = 4.dp),
                ...
                IconButton(
                    onClick = { onCopyTxHash(record.ganacheTxHash) },
